...
import eva_sentence_classification
...
def detect_sentence(text):
    response = eva_sentence_classification.main(text)
    return response
...
print(main("I have some questions I would like to ask, if now is a good time"))
