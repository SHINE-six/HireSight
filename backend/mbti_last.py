...
model = load('model/mbti_xgb_personality_model.joblib')
vectorizer = load('model/mbti_vectorizer.joblib')
tfizer = load('model/mbti_tfidf_transformer.joblib')
label_encoder = load('model/mbti_label_encoder.joblib')
...
def generate_wordcloud(data, image_path, title):
    ...
    # Save the image
    plt.savefig("mbtiFolder/wordcloud.png")
...
def main(text):
    ...
    image_path = f'mbtiFolder/mbti_pic/{predicted_personality.lower()}.jpg'
