                                    ...
                                    return (
                                        <div className='mx-[2rem]'>
                                            <div key={resume.uniqueSessionID} className={`w-full ${bgColor} rounded-md shadow-md text- smdhadow-black mb-[1rem] p-[1rem] justify-items-center items-center grid grid-cols-6`}>
                                                ...
                                                <button className="bg-blue-700 rounded-lg px-[1rem] py-[0.5rem] h-full text-white hover:bg-blue-900 focus:outline-none focus:ring-2" onClick={handleReportClick}>View Report</button>
                                            </div>
                                        </div>
                                    );
                                })}
